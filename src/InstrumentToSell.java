public class InstrumentToSell extends Instrument {
    //creating attributes
    private int price, discountPercent;
    ...
    public void sellInstruments(String customerName, String phone, 
                                int PANnumber, String sellDate, int discountPercent)
    {
        ...
        if(isSold){
            ...
            setPrice((price - (discountPercent/100) * price));
            setSold(true);
        }
    }
